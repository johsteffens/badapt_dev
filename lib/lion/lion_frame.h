...
stamp :s = aware :
{
    ...
    func : .create_from_source     = { d @* o = @_create(); return @_setup_from_source( o, source, en, size_en ).cast( d $* ); };
    func : .create_from_st         = { d @* o = @_create(); return @_setup_from_st(     o, st,     en, size_en ).cast( d $* ); };
    func : .create_from_sc         = { d @* o = @_create(); return @_setup_from_sc(     o, sc,     en, size_en ).cast( d $* ); };
