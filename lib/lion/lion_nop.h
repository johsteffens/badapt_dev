...
/** Low level solving.
  ...
  */
feature bl_t solve( const, lion_holor_s** a, :solve_result_s* result ) extern _;

/** Node-level solving. */
feature void solve_node( mutable, lion_net_node_s* node, lion_net_node_adl_s* deferred ) extern _;
