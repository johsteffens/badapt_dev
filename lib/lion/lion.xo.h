 ...
 *  Last File Update: 2020-12-07T21:34:39Z
 *
...
#define HKEYOF_lion_xo 0x65B144B14DA7B2CFull

#define TYPEOF_lion_xo 0x20285EF15EE0D445ull
...
#define TYPEOF_lion_spect_s 0xFCA857C4073949AFull
...
#define BETH_EXPAND_ITEM_lion_hmeta_s \
  ...
  static inline void lion_hmeta_s_clear( lion_hmeta_s* o ); \
  static inline tp_t lion_hmeta_s_get_name( const lion_hmeta_s* o ); \
  static inline tp_t lion_hmeta_s_get_pclass( const lion_hmeta_s* o ); \
  static inline bl_t lion_hmeta_s_is_rollable( const lion_hmeta_s* o ); \
  static inline bl_t lion_hmeta_s_is_active( const lion_hmeta_s* o ); \
  static inline bcore_inst* lion_hmeta_s_get_custom( const lion_hmeta_s* o ); \
  static inline bcore_inst* lion_hmeta_s_set_custom( lion_hmeta_s* o, const bcore_inst* custom ); \
  static inline bhvm_mcode_node_s* lion_hmeta_s_get_node( const lion_hmeta_s* o ); \
  static inline void lion_hmeta_s_set_node( lion_hmeta_s* o, bhvm_mcode_node_s* node ); \
...
#define BETH_EXPAND_GROUP_lion \
  ...
  XOILA_DECLARE_SPECT( lion ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( lion ) \
...
#define TYPEOF_lion_nop_spect_s 0x3D1B46DD6B537959ull
...
#define BETH_EXPAND_ITEM_lion_nop_context_s \
  ...
  { \
      aware_t _; \
      bcore_mutex_s randomizer_mutex; \
      bl_t randomizer_is_locked; \
      u3_t randomizer_rval; \
  };
#define BETH_EXPAND_GROUP_lion_nop \
  ...
  static inline sz_t lion_nop_a_arity( const lion_nop* o ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->arity ); return p->arity( o );} \
  static inline bl_t lion_nop_a_defines_arity( const lion_nop* o ){ return  true;} \
  static inline sz_t lion_nop_arity_default( const lion_nop* o ){ ERR_fa( "Not implemented in '#<sc_t>'.", ifnameof( o->_ ) ); return  -1;} \
  static inline sz_t lion_nop_a_priority( const lion_nop* o ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->priority ); return p->priority( o );} \
  static inline bl_t lion_nop_a_defines_priority( const lion_nop* o ){ return  true;} \
  static inline sz_t lion_nop_priority_default( const lion_nop* o ){ return  10;} \
  static inline sc_t lion_nop_a_symbol( const lion_nop* o ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->symbol ); return p->symbol( o );} \
  static inline bl_t lion_nop_a_defines_symbol( const lion_nop* o ){ return  true;} \
  static inline sc_t lion_nop_symbol_default( const lion_nop* o ){ return  NULL;} \
  static inline bl_t lion_nop_a_reserved( const lion_nop* o ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->reserved ); return p->reserved( o );} \
  static inline bl_t lion_nop_a_defines_reserved( const lion_nop* o ){ return  true;} \
  static inline bl_t lion_nop_reserved_default( const lion_nop* o ){ return  false;} \
  static inline lion_nop* lion_nop_a_create_op_of_arn( const lion_nop* o, sz_t n ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->create_op_of_arn ); return p->create_op_of_arn( o, n );} \
  static inline bl_t lion_nop_a_defines_create_op_of_arn( const lion_nop* o ){ return  true;} \
  static inline lion_nop* lion_nop_create_op_of_arn_default( const lion_nop* o, sz_t n ){ return  ( lion_nop_a_arity( o ) == n ) ? lion_nop_a_clone( o ) : NULL;} \
  BETH_EXPAND_ITEM_lion_nop_solve_result_s \
  static inline bl_t lion_nop_a_eci( const lion_nop* o ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->eci ); return p->eci( o );} \
  static inline bl_t lion_nop_a_defines_eci( const lion_nop* o ){ return  true;} \
  static inline bl_t lion_nop_eci_default( const lion_nop* o ){ return  false;} \
  static inline bl_t lion_nop_a_solve( const lion_nop* o, lion_holor_s** a, lion_nop_solve_result_s* result ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->solve ); return p->solve( o, a, result );} \
  ...
  static inline void lion_nop_a_solve_node( lion_nop* o, lion_net_node_s* node, lion_net_node_adl_s* deferred ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->solve_node ); p->solve_node( o, node, deferred );} \
  ...
  static inline bl_t lion_nop_a_is_cyclic( const lion_nop* o ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->is_cyclic ); return p->is_cyclic( o );} \
  static inline bl_t lion_nop_a_defines_is_cyclic( const lion_nop* o ){ return  true;} \
  static inline bl_t lion_nop_is_cyclic_default( const lion_nop* o ){ return  false;} \
  static inline bl_t lion_nop_a_is_adaptive( const lion_nop* o ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->is_adaptive ); return p->is_adaptive( o );} \
  static inline bl_t lion_nop_a_defines_is_adaptive( const lion_nop* o ){ return  true;} \
  static inline bl_t lion_nop_is_adaptive_default( const lion_nop* o ){ return  false;} \
  static inline void lion_nop_a_settle( const lion_nop* o, const lion_nop_solve_result_s* result, lion_nop** out_nop, lion_nop_solve_result_s** out_result ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->settle ); p->settle( o, result, out_nop, out_result );} \
  ...
  static inline tp_t lion_nop_a_type_vop_ap( const lion_nop* o ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->type_vop_ap ); return p->type_vop_ap( o );} \
  static inline bl_t lion_nop_a_defines_type_vop_ap( const lion_nop* o ){ return  lion_nop_spect_s_get_aware( o )->type_vop_ap != NULL;} \
  static inline tp_t lion_nop_a_type_vop_dp_a( const lion_nop* o ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->type_vop_dp_a ); return p->type_vop_dp_a( o );} \
  static inline bl_t lion_nop_a_defines_type_vop_dp_a( const lion_nop* o ){ return  lion_nop_spect_s_get_aware( o )->type_vop_dp_a != NULL;} \
  static inline tp_t lion_nop_a_type_vop_dp_b( const lion_nop* o ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->type_vop_dp_b ); return p->type_vop_dp_b( o );} \
  static inline bl_t lion_nop_a_defines_type_vop_dp_b( const lion_nop* o ){ return  lion_nop_spect_s_get_aware( o )->type_vop_dp_b != NULL;} \
  static inline tp_t lion_nop_a_type_vop_dp_c( const lion_nop* o ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->type_vop_dp_c ); return p->type_vop_dp_c( o );} \
  static inline bl_t lion_nop_a_defines_type_vop_dp_c( const lion_nop* o ){ return  lion_nop_spect_s_get_aware( o )->type_vop_dp_c != NULL;} \
  static inline sz_t lion_nop_a_mcode_push_ap_holor( const lion_nop* o, const lion_nop_solve_result_s* result, const bhvm_vop_arr_ci_s* arr_ci, bhvm_mcode_frame_s* mcf ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->mcode_push_ap_holor ); return p->mcode_push_ap_holor( o, result, arr_ci, mcf );} \
  ...
  static inline sz_t lion_nop_a_mcode_push_dp_holor( const lion_nop* o, const lion_nop_solve_result_s* result, const bhvm_vop_arr_ci_s* arr_ci, bhvm_mcode_frame_s* mcf ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->mcode_push_dp_holor ); return p->mcode_push_dp_holor( o, result, arr_ci, mcf );} \
  ...
  static inline void lion_nop_a_mcode_push_ap_track( const lion_nop* o, const lion_nop_solve_result_s* result, const bhvm_vop_arr_ci_s* arr_ci, bhvm_mcode_frame_s* mcf ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->mcode_push_ap_track ); p->mcode_push_ap_track( o, result, arr_ci, mcf );} \
  ...
  static inline void lion_nop_a_mcode_push_dp_track( const lion_nop* o, const lion_nop_solve_result_s* result, u0_t ch_id, const bhvm_vop_arr_ci_s* arr_ci, bhvm_mcode_frame_s* mcf ){ const lion_nop_spect_s* p = lion_nop_spect_s_get_aware( o ); assert( p->mcode_push_dp_track ); p->mcode_push_dp_track( o, result, ch_id, arr_ci, mcf );} \
...
#define TYPEOF_lion_nop_ar0_spect_s 0xC6123FFF9DAA9D0Full
...
#define BETH_EXPAND_ITEM_lion_nop_ar0_literal_s \
  ...
  static inline sz_t lion_nop_ar0_literal_s_arity( const lion_nop_ar0_literal_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar0_param_s \
  ...
  static inline sz_t lion_nop_ar0_param_s_arity( const lion_nop_ar0_param_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar0_adaptive_s \
  ...
  static inline sz_t lion_nop_ar0_adaptive_s_arity( const lion_nop_ar0_adaptive_s* o ); \
  static inline bl_t lion_nop_ar0_adaptive_s_is_adaptive( const lion_nop_ar0_adaptive_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar0_rand_s \
  ...
  static inline sz_t lion_nop_ar0_rand_s_arity( const lion_nop_ar0_rand_s* o ); \
...
#define BETH_EXPAND_GROUP_lion_nop_ar0 \
  ...
  XOILA_DECLARE_SPECT( lion_nop_ar0 ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( lion_nop_ar0 ) \
...
#define TYPEOF_lion_nop_ar1_spect_s 0xFC5C4ACA3C66B6E4ull
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_identity_s \
  ...
  static inline sz_t lion_nop_ar1_identity_s_arity( const lion_nop_ar1_identity_s* o ); \
  static inline bl_t lion_nop_ar1_identity_s_reserved( const lion_nop_ar1_identity_s* o ); \
  static inline sz_t lion_nop_ar1_identity_s_priority( const lion_nop_ar1_identity_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_f3_s \
  ...
  static inline sz_t lion_nop_ar1_f3_s_arity( const lion_nop_ar1_f3_s* o ); \
  static inline bl_t lion_nop_ar1_f3_s_reserved( const lion_nop_ar1_f3_s* o ); \
  static inline sz_t lion_nop_ar1_f3_s_priority( const lion_nop_ar1_f3_s* o ); \
  static inline sc_t lion_nop_ar1_f3_s_symbol( const lion_nop_ar1_f3_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_f2_s \
  ...
  static inline sz_t lion_nop_ar1_f2_s_arity( const lion_nop_ar1_f2_s* o ); \
  static inline bl_t lion_nop_ar1_f2_s_reserved( const lion_nop_ar1_f2_s* o ); \
  static inline sz_t lion_nop_ar1_f2_s_priority( const lion_nop_ar1_f2_s* o ); \
  static inline sc_t lion_nop_ar1_f2_s_symbol( const lion_nop_ar1_f2_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_neg_s \
  ...
  static inline sz_t lion_nop_ar1_neg_s_arity( const lion_nop_ar1_neg_s* o ); \
  static inline bl_t lion_nop_ar1_neg_s_reserved( const lion_nop_ar1_neg_s* o ); \
  static inline sz_t lion_nop_ar1_neg_s_priority( const lion_nop_ar1_neg_s* o ); \
  static inline sc_t lion_nop_ar1_neg_s_symbol( const lion_nop_ar1_neg_s* o ); \
  static inline tp_t lion_nop_ar1_neg_s_type_vop_ap( const lion_nop_ar1_neg_s* o ); \
  static inline tp_t lion_nop_ar1_neg_s_type_vop_dp_a( const lion_nop_ar1_neg_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_floor_s \
  ...
  static inline sz_t lion_nop_ar1_floor_s_arity( const lion_nop_ar1_floor_s* o ); \
  static inline bl_t lion_nop_ar1_floor_s_reserved( const lion_nop_ar1_floor_s* o ); \
  static inline sz_t lion_nop_ar1_floor_s_priority( const lion_nop_ar1_floor_s* o ); \
  static inline sc_t lion_nop_ar1_floor_s_symbol( const lion_nop_ar1_floor_s* o ); \
  static inline tp_t lion_nop_ar1_floor_s_type_vop_ap( const lion_nop_ar1_floor_s* o ); \
  static inline sz_t lion_nop_ar1_floor_s_mcode_push_dp_holor( const lion_nop_ar1_floor_s* o, const lion_nop_solve_result_s* result, const bhvm_vop_arr_ci_s* arr_ci, bhvm_mcode_frame_s* mcf ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_ceil_s \
  ...
  static inline sz_t lion_nop_ar1_ceil_s_arity( const lion_nop_ar1_ceil_s* o ); \
  static inline bl_t lion_nop_ar1_ceil_s_reserved( const lion_nop_ar1_ceil_s* o ); \
  static inline sz_t lion_nop_ar1_ceil_s_priority( const lion_nop_ar1_ceil_s* o ); \
  static inline sc_t lion_nop_ar1_ceil_s_symbol( const lion_nop_ar1_ceil_s* o ); \
  static inline tp_t lion_nop_ar1_ceil_s_type_vop_ap( const lion_nop_ar1_ceil_s* o ); \
  static inline sz_t lion_nop_ar1_ceil_s_mcode_push_dp_holor( const lion_nop_ar1_ceil_s* o, const lion_nop_solve_result_s* result, const bhvm_vop_arr_ci_s* arr_ci, bhvm_mcode_frame_s* mcf ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_abs_s \
  ...
  static inline sz_t lion_nop_ar1_abs_s_arity( const lion_nop_ar1_abs_s* o ); \
  static inline bl_t lion_nop_ar1_abs_s_reserved( const lion_nop_ar1_abs_s* o ); \
  static inline sz_t lion_nop_ar1_abs_s_priority( const lion_nop_ar1_abs_s* o ); \
  static inline sc_t lion_nop_ar1_abs_s_symbol( const lion_nop_ar1_abs_s* o ); \
  static inline tp_t lion_nop_ar1_abs_s_type_vop_ap( const lion_nop_ar1_abs_s* o ); \
  static inline tp_t lion_nop_ar1_abs_s_type_vop_dp_a( const lion_nop_ar1_abs_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_exp_s \
  ...
  static inline sz_t lion_nop_ar1_exp_s_arity( const lion_nop_ar1_exp_s* o ); \
  static inline bl_t lion_nop_ar1_exp_s_reserved( const lion_nop_ar1_exp_s* o ); \
  static inline sz_t lion_nop_ar1_exp_s_priority( const lion_nop_ar1_exp_s* o ); \
  static inline sc_t lion_nop_ar1_exp_s_symbol( const lion_nop_ar1_exp_s* o ); \
  static inline tp_t lion_nop_ar1_exp_s_type_vop_ap( const lion_nop_ar1_exp_s* o ); \
  static inline tp_t lion_nop_ar1_exp_s_type_vop_dp_a( const lion_nop_ar1_exp_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_log_s \
  ...
  static inline sz_t lion_nop_ar1_log_s_arity( const lion_nop_ar1_log_s* o ); \
  static inline bl_t lion_nop_ar1_log_s_reserved( const lion_nop_ar1_log_s* o ); \
  static inline sz_t lion_nop_ar1_log_s_priority( const lion_nop_ar1_log_s* o ); \
  static inline sc_t lion_nop_ar1_log_s_symbol( const lion_nop_ar1_log_s* o ); \
  static inline tp_t lion_nop_ar1_log_s_type_vop_ap( const lion_nop_ar1_log_s* o ); \
  static inline tp_t lion_nop_ar1_log_s_type_vop_dp_a( const lion_nop_ar1_log_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_inv_s \
  ...
  static inline sz_t lion_nop_ar1_inv_s_arity( const lion_nop_ar1_inv_s* o ); \
  static inline bl_t lion_nop_ar1_inv_s_reserved( const lion_nop_ar1_inv_s* o ); \
  static inline sz_t lion_nop_ar1_inv_s_priority( const lion_nop_ar1_inv_s* o ); \
  static inline sc_t lion_nop_ar1_inv_s_symbol( const lion_nop_ar1_inv_s* o ); \
  static inline tp_t lion_nop_ar1_inv_s_type_vop_ap( const lion_nop_ar1_inv_s* o ); \
  static inline tp_t lion_nop_ar1_inv_s_type_vop_dp_a( const lion_nop_ar1_inv_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_sqr_s \
  ...
  static inline sz_t lion_nop_ar1_sqr_s_arity( const lion_nop_ar1_sqr_s* o ); \
  static inline bl_t lion_nop_ar1_sqr_s_reserved( const lion_nop_ar1_sqr_s* o ); \
  static inline sz_t lion_nop_ar1_sqr_s_priority( const lion_nop_ar1_sqr_s* o ); \
  static inline sc_t lion_nop_ar1_sqr_s_symbol( const lion_nop_ar1_sqr_s* o ); \
  static inline tp_t lion_nop_ar1_sqr_s_type_vop_ap( const lion_nop_ar1_sqr_s* o ); \
  static inline tp_t lion_nop_ar1_sqr_s_type_vop_dp_a( const lion_nop_ar1_sqr_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_srt_s \
  ...
  static inline sz_t lion_nop_ar1_srt_s_arity( const lion_nop_ar1_srt_s* o ); \
  static inline bl_t lion_nop_ar1_srt_s_reserved( const lion_nop_ar1_srt_s* o ); \
  static inline sz_t lion_nop_ar1_srt_s_priority( const lion_nop_ar1_srt_s* o ); \
  static inline sc_t lion_nop_ar1_srt_s_symbol( const lion_nop_ar1_srt_s* o ); \
  static inline tp_t lion_nop_ar1_srt_s_type_vop_ap( const lion_nop_ar1_srt_s* o ); \
  static inline tp_t lion_nop_ar1_srt_s_type_vop_dp_a( const lion_nop_ar1_srt_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_sigm_s \
  ...
  static inline sz_t lion_nop_ar1_sigm_s_arity( const lion_nop_ar1_sigm_s* o ); \
  static inline bl_t lion_nop_ar1_sigm_s_reserved( const lion_nop_ar1_sigm_s* o ); \
  static inline sz_t lion_nop_ar1_sigm_s_priority( const lion_nop_ar1_sigm_s* o ); \
  static inline sc_t lion_nop_ar1_sigm_s_symbol( const lion_nop_ar1_sigm_s* o ); \
  static inline tp_t lion_nop_ar1_sigm_s_type_vop_ap( const lion_nop_ar1_sigm_s* o ); \
  static inline tp_t lion_nop_ar1_sigm_s_type_vop_dp_a( const lion_nop_ar1_sigm_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_sigm_hard_s \
  ...
  static inline sz_t lion_nop_ar1_sigm_hard_s_arity( const lion_nop_ar1_sigm_hard_s* o ); \
  static inline bl_t lion_nop_ar1_sigm_hard_s_reserved( const lion_nop_ar1_sigm_hard_s* o ); \
  static inline sz_t lion_nop_ar1_sigm_hard_s_priority( const lion_nop_ar1_sigm_hard_s* o ); \
  static inline sc_t lion_nop_ar1_sigm_hard_s_symbol( const lion_nop_ar1_sigm_hard_s* o ); \
  static inline tp_t lion_nop_ar1_sigm_hard_s_type_vop_ap( const lion_nop_ar1_sigm_hard_s* o ); \
  static inline tp_t lion_nop_ar1_sigm_hard_s_type_vop_dp_a( const lion_nop_ar1_sigm_hard_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_sigm_leaky_s \
  ...
  static inline sz_t lion_nop_ar1_sigm_leaky_s_arity( const lion_nop_ar1_sigm_leaky_s* o ); \
  static inline bl_t lion_nop_ar1_sigm_leaky_s_reserved( const lion_nop_ar1_sigm_leaky_s* o ); \
  static inline sz_t lion_nop_ar1_sigm_leaky_s_priority( const lion_nop_ar1_sigm_leaky_s* o ); \
  static inline sc_t lion_nop_ar1_sigm_leaky_s_symbol( const lion_nop_ar1_sigm_leaky_s* o ); \
  static inline tp_t lion_nop_ar1_sigm_leaky_s_type_vop_ap( const lion_nop_ar1_sigm_leaky_s* o ); \
  static inline tp_t lion_nop_ar1_sigm_leaky_s_type_vop_dp_a( const lion_nop_ar1_sigm_leaky_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_tanh_s \
  ...
  static inline sz_t lion_nop_ar1_tanh_s_arity( const lion_nop_ar1_tanh_s* o ); \
  static inline bl_t lion_nop_ar1_tanh_s_reserved( const lion_nop_ar1_tanh_s* o ); \
  static inline sz_t lion_nop_ar1_tanh_s_priority( const lion_nop_ar1_tanh_s* o ); \
  static inline sc_t lion_nop_ar1_tanh_s_symbol( const lion_nop_ar1_tanh_s* o ); \
  static inline tp_t lion_nop_ar1_tanh_s_type_vop_ap( const lion_nop_ar1_tanh_s* o ); \
  static inline tp_t lion_nop_ar1_tanh_s_type_vop_dp_a( const lion_nop_ar1_tanh_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_tanh_hard_s \
  ...
  static inline sz_t lion_nop_ar1_tanh_hard_s_arity( const lion_nop_ar1_tanh_hard_s* o ); \
  static inline bl_t lion_nop_ar1_tanh_hard_s_reserved( const lion_nop_ar1_tanh_hard_s* o ); \
  static inline sz_t lion_nop_ar1_tanh_hard_s_priority( const lion_nop_ar1_tanh_hard_s* o ); \
  static inline sc_t lion_nop_ar1_tanh_hard_s_symbol( const lion_nop_ar1_tanh_hard_s* o ); \
  static inline tp_t lion_nop_ar1_tanh_hard_s_type_vop_ap( const lion_nop_ar1_tanh_hard_s* o ); \
  static inline tp_t lion_nop_ar1_tanh_hard_s_type_vop_dp_a( const lion_nop_ar1_tanh_hard_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_tanh_leaky_s \
  ...
  static inline sz_t lion_nop_ar1_tanh_leaky_s_arity( const lion_nop_ar1_tanh_leaky_s* o ); \
  static inline bl_t lion_nop_ar1_tanh_leaky_s_reserved( const lion_nop_ar1_tanh_leaky_s* o ); \
  static inline sz_t lion_nop_ar1_tanh_leaky_s_priority( const lion_nop_ar1_tanh_leaky_s* o ); \
  static inline sc_t lion_nop_ar1_tanh_leaky_s_symbol( const lion_nop_ar1_tanh_leaky_s* o ); \
  static inline tp_t lion_nop_ar1_tanh_leaky_s_type_vop_ap( const lion_nop_ar1_tanh_leaky_s* o ); \
  static inline tp_t lion_nop_ar1_tanh_leaky_s_type_vop_dp_a( const lion_nop_ar1_tanh_leaky_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_softplus_s \
  ...
  static inline sz_t lion_nop_ar1_softplus_s_arity( const lion_nop_ar1_softplus_s* o ); \
  static inline bl_t lion_nop_ar1_softplus_s_reserved( const lion_nop_ar1_softplus_s* o ); \
  static inline sz_t lion_nop_ar1_softplus_s_priority( const lion_nop_ar1_softplus_s* o ); \
  static inline sc_t lion_nop_ar1_softplus_s_symbol( const lion_nop_ar1_softplus_s* o ); \
  static inline tp_t lion_nop_ar1_softplus_s_type_vop_ap( const lion_nop_ar1_softplus_s* o ); \
  static inline tp_t lion_nop_ar1_softplus_s_type_vop_dp_a( const lion_nop_ar1_softplus_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_softmax_s \
  ...
  static inline sz_t lion_nop_ar1_softmax_s_arity( const lion_nop_ar1_softmax_s* o ); \
  static inline bl_t lion_nop_ar1_softmax_s_reserved( const lion_nop_ar1_softmax_s* o ); \
  static inline sz_t lion_nop_ar1_softmax_s_priority( const lion_nop_ar1_softmax_s* o ); \
  static inline sc_t lion_nop_ar1_softmax_s_symbol( const lion_nop_ar1_softmax_s* o ); \
  static inline tp_t lion_nop_ar1_softmax_s_type_vop_ap( const lion_nop_ar1_softmax_s* o ); \
  static inline tp_t lion_nop_ar1_softmax_s_type_vop_dp_a( const lion_nop_ar1_softmax_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_relu_s \
  ...
  static inline sz_t lion_nop_ar1_relu_s_arity( const lion_nop_ar1_relu_s* o ); \
  static inline bl_t lion_nop_ar1_relu_s_reserved( const lion_nop_ar1_relu_s* o ); \
  static inline sz_t lion_nop_ar1_relu_s_priority( const lion_nop_ar1_relu_s* o ); \
  static inline sc_t lion_nop_ar1_relu_s_symbol( const lion_nop_ar1_relu_s* o ); \
  static inline tp_t lion_nop_ar1_relu_s_type_vop_ap( const lion_nop_ar1_relu_s* o ); \
  static inline tp_t lion_nop_ar1_relu_s_type_vop_dp_a( const lion_nop_ar1_relu_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_relu_leaky_s \
  ...
  static inline sz_t lion_nop_ar1_relu_leaky_s_arity( const lion_nop_ar1_relu_leaky_s* o ); \
  static inline bl_t lion_nop_ar1_relu_leaky_s_reserved( const lion_nop_ar1_relu_leaky_s* o ); \
  static inline sz_t lion_nop_ar1_relu_leaky_s_priority( const lion_nop_ar1_relu_leaky_s* o ); \
  static inline sc_t lion_nop_ar1_relu_leaky_s_symbol( const lion_nop_ar1_relu_leaky_s* o ); \
  static inline tp_t lion_nop_ar1_relu_leaky_s_type_vop_ap( const lion_nop_ar1_relu_leaky_s* o ); \
  static inline tp_t lion_nop_ar1_relu_leaky_s_type_vop_dp_a( const lion_nop_ar1_relu_leaky_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_output_s \
  ...
  static inline sz_t lion_nop_ar1_output_s_arity( const lion_nop_ar1_output_s* o ); \
  static inline bl_t lion_nop_ar1_output_s_reserved( const lion_nop_ar1_output_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_adaptive_s \
  ...
  static inline sz_t lion_nop_ar1_adaptive_s_arity( const lion_nop_ar1_adaptive_s* o ); \
  static inline bl_t lion_nop_ar1_adaptive_s_reserved( const lion_nop_ar1_adaptive_s* o ); \
  static inline sz_t lion_nop_ar1_adaptive_s_priority( const lion_nop_ar1_adaptive_s* o ); \
  static inline bl_t lion_nop_ar1_adaptive_s_is_adaptive( const lion_nop_ar1_adaptive_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_dimof_s \
  ...
  static inline sz_t lion_nop_ar1_dimof_s_arity( const lion_nop_ar1_dimof_s* o ); \
  static inline bl_t lion_nop_ar1_dimof_s_reserved( const lion_nop_ar1_dimof_s* o ); \
  static inline sc_t lion_nop_ar1_dimof_s_symbol( const lion_nop_ar1_dimof_s* o ); \
  static inline sz_t lion_nop_ar1_dimof_s_priority( const lion_nop_ar1_dimof_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_volof_s \
  ...
  static inline sz_t lion_nop_ar1_volof_s_arity( const lion_nop_ar1_volof_s* o ); \
  static inline bl_t lion_nop_ar1_volof_s_reserved( const lion_nop_ar1_volof_s* o ); \
  static inline sc_t lion_nop_ar1_volof_s_symbol( const lion_nop_ar1_volof_s* o ); \
  static inline sz_t lion_nop_ar1_volof_s_priority( const lion_nop_ar1_volof_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_constof_s \
  ...
  static inline sz_t lion_nop_ar1_constof_s_arity( const lion_nop_ar1_constof_s* o ); \
  static inline bl_t lion_nop_ar1_constof_s_reserved( const lion_nop_ar1_constof_s* o ); \
  static inline sc_t lion_nop_ar1_constof_s_symbol( const lion_nop_ar1_constof_s* o ); \
  static inline sz_t lion_nop_ar1_constof_s_priority( const lion_nop_ar1_constof_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_zeroof_s \
  ...
  static inline sz_t lion_nop_ar1_zeroof_s_arity( const lion_nop_ar1_zeroof_s* o ); \
  static inline bl_t lion_nop_ar1_zeroof_s_reserved( const lion_nop_ar1_zeroof_s* o ); \
  static inline sc_t lion_nop_ar1_zeroof_s_symbol( const lion_nop_ar1_zeroof_s* o ); \
  static inline sz_t lion_nop_ar1_zeroof_s_priority( const lion_nop_ar1_zeroof_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_shapeof_s \
  ...
  static inline sz_t lion_nop_ar1_shapeof_s_arity( const lion_nop_ar1_shapeof_s* o ); \
  static inline bl_t lion_nop_ar1_shapeof_s_reserved( const lion_nop_ar1_shapeof_s* o ); \
  static inline sc_t lion_nop_ar1_shapeof_s_symbol( const lion_nop_ar1_shapeof_s* o ); \
  static inline sz_t lion_nop_ar1_shapeof_s_priority( const lion_nop_ar1_shapeof_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_rand_s \
  ...
  static inline sz_t lion_nop_ar1_rand_s_arity( const lion_nop_ar1_rand_s* o ); \
  static inline bl_t lion_nop_ar1_rand_s_reserved( const lion_nop_ar1_rand_s* o ); \
  static inline sc_t lion_nop_ar1_rand_s_symbol( const lion_nop_ar1_rand_s* o ); \
  static inline sz_t lion_nop_ar1_rand_s_priority( const lion_nop_ar1_rand_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_cast_htp_s \
  ...
  static inline sz_t lion_nop_ar1_cast_htp_s_arity( const lion_nop_ar1_cast_htp_s* o ); \
  static inline bl_t lion_nop_ar1_cast_htp_s_reserved( const lion_nop_ar1_cast_htp_s* o ); \
  static inline sz_t lion_nop_ar1_cast_htp_s_priority( const lion_nop_ar1_cast_htp_s* o ); \
  static inline sc_t lion_nop_ar1_cast_htp_s_symbol( const lion_nop_ar1_cast_htp_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar1_reshape_s \
  ...
  static inline sz_t lion_nop_ar1_reshape_s_arity( const lion_nop_ar1_reshape_s* o ); \
  static inline bl_t lion_nop_ar1_reshape_s_reserved( const lion_nop_ar1_reshape_s* o ); \
  static inline sz_t lion_nop_ar1_reshape_s_priority( const lion_nop_ar1_reshape_s* o ); \
...
#define BETH_EXPAND_GROUP_lion_nop_ar1 \
  ...
  XOILA_DECLARE_SPECT( lion_nop_ar1 ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( lion_nop_ar1 ) \
...
#define TYPEOF_lion_nop_ar2_spect_s 0xF2754613A78CCAE1ull
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_add_s \
  ...
  static inline sz_t lion_nop_ar2_add_s_arity( const lion_nop_ar2_add_s* o ); \
  static inline bl_t lion_nop_ar2_add_s_reserved( const lion_nop_ar2_add_s* o ); \
  static inline sz_t lion_nop_ar2_add_s_priority( const lion_nop_ar2_add_s* o ); \
  static inline bl_t lion_nop_ar2_add_s_eci( const lion_nop_ar2_add_s* o ); \
  static inline sc_t lion_nop_ar2_add_s_symbol( const lion_nop_ar2_add_s* o ); \
  static inline tp_t lion_nop_ar2_add_s_type_vop_ap( const lion_nop_ar2_add_s* o ); \
  static inline tp_t lion_nop_ar2_add_s_type_vop_dp_a( const lion_nop_ar2_add_s* o ); \
  static inline tp_t lion_nop_ar2_add_s_type_vop_dp_b( const lion_nop_ar2_add_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_sub_s \
  ...
  static inline sz_t lion_nop_ar2_sub_s_arity( const lion_nop_ar2_sub_s* o ); \
  static inline bl_t lion_nop_ar2_sub_s_reserved( const lion_nop_ar2_sub_s* o ); \
  static inline sz_t lion_nop_ar2_sub_s_priority( const lion_nop_ar2_sub_s* o ); \
  static inline bl_t lion_nop_ar2_sub_s_eci( const lion_nop_ar2_sub_s* o ); \
  static inline sc_t lion_nop_ar2_sub_s_symbol( const lion_nop_ar2_sub_s* o ); \
  static inline tp_t lion_nop_ar2_sub_s_type_vop_ap( const lion_nop_ar2_sub_s* o ); \
  static inline tp_t lion_nop_ar2_sub_s_type_vop_dp_a( const lion_nop_ar2_sub_s* o ); \
  static inline tp_t lion_nop_ar2_sub_s_type_vop_dp_b( const lion_nop_ar2_sub_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_mul_s \
  ...
  static inline sz_t lion_nop_ar2_mul_s_arity( const lion_nop_ar2_mul_s* o ); \
  static inline bl_t lion_nop_ar2_mul_s_reserved( const lion_nop_ar2_mul_s* o ); \
  static inline sz_t lion_nop_ar2_mul_s_priority( const lion_nop_ar2_mul_s* o ); \
  static inline bl_t lion_nop_ar2_mul_s_eci( const lion_nop_ar2_mul_s* o ); \
  static inline sc_t lion_nop_ar2_mul_s_symbol( const lion_nop_ar2_mul_s* o ); \
  static inline tp_t lion_nop_ar2_mul_s_type_vop_ap( const lion_nop_ar2_mul_s* o ); \
  static inline tp_t lion_nop_ar2_mul_s_type_vop_dp_a( const lion_nop_ar2_mul_s* o ); \
  static inline tp_t lion_nop_ar2_mul_s_type_vop_dp_b( const lion_nop_ar2_mul_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_div_s \
  ...
  static inline sz_t lion_nop_ar2_div_s_arity( const lion_nop_ar2_div_s* o ); \
  static inline bl_t lion_nop_ar2_div_s_reserved( const lion_nop_ar2_div_s* o ); \
  static inline sz_t lion_nop_ar2_div_s_priority( const lion_nop_ar2_div_s* o ); \
  static inline bl_t lion_nop_ar2_div_s_eci( const lion_nop_ar2_div_s* o ); \
  static inline sc_t lion_nop_ar2_div_s_symbol( const lion_nop_ar2_div_s* o ); \
  static inline tp_t lion_nop_ar2_div_s_type_vop_ap( const lion_nop_ar2_div_s* o ); \
  static inline tp_t lion_nop_ar2_div_s_type_vop_dp_a( const lion_nop_ar2_div_s* o ); \
  static inline tp_t lion_nop_ar2_div_s_type_vop_dp_b( const lion_nop_ar2_div_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_pow_s \
  ...
  static inline sz_t lion_nop_ar2_pow_s_arity( const lion_nop_ar2_pow_s* o ); \
  static inline bl_t lion_nop_ar2_pow_s_reserved( const lion_nop_ar2_pow_s* o ); \
  static inline sz_t lion_nop_ar2_pow_s_priority( const lion_nop_ar2_pow_s* o ); \
  static inline bl_t lion_nop_ar2_pow_s_eci( const lion_nop_ar2_pow_s* o ); \
  static inline sc_t lion_nop_ar2_pow_s_symbol( const lion_nop_ar2_pow_s* o ); \
  static inline tp_t lion_nop_ar2_pow_s_type_vop_ap( const lion_nop_ar2_pow_s* o ); \
  static inline tp_t lion_nop_ar2_pow_s_type_vop_dp_a( const lion_nop_ar2_pow_s* o ); \
  static inline tp_t lion_nop_ar2_pow_s_type_vop_dp_b( const lion_nop_ar2_pow_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_bmul_s \
  ...
  static inline sz_t lion_nop_ar2_bmul_s_arity( const lion_nop_ar2_bmul_s* o ); \
  static inline bl_t lion_nop_ar2_bmul_s_reserved( const lion_nop_ar2_bmul_s* o ); \
  static inline sz_t lion_nop_ar2_bmul_s_priority( const lion_nop_ar2_bmul_s* o ); \
  static inline sc_t lion_nop_ar2_bmul_s_symbol( const lion_nop_ar2_bmul_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_logic_equal_s \
  ...
  static inline sz_t lion_nop_ar2_logic_equal_s_arity( const lion_nop_ar2_logic_equal_s* o ); \
  static inline bl_t lion_nop_ar2_logic_equal_s_reserved( const lion_nop_ar2_logic_equal_s* o ); \
  static inline sz_t lion_nop_ar2_logic_equal_s_priority( const lion_nop_ar2_logic_equal_s* o ); \
  static inline bl_t lion_nop_ar2_logic_equal_s_eci( const lion_nop_ar2_logic_equal_s* o ); \
  static inline sc_t lion_nop_ar2_logic_equal_s_symbol( const lion_nop_ar2_logic_equal_s* o ); \
  static inline tp_t lion_nop_ar2_logic_equal_s_type_vop_ap( const lion_nop_ar2_logic_equal_s* o ); \
  static inline sz_t lion_nop_ar2_logic_equal_s_mcode_push_dp_holor( const lion_nop_ar2_logic_equal_s* o, const lion_nop_solve_result_s* result, const bhvm_vop_arr_ci_s* arr_ci, bhvm_mcode_frame_s* mcf ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_logic_unequal_s \
  ...
  static inline sz_t lion_nop_ar2_logic_unequal_s_arity( const lion_nop_ar2_logic_unequal_s* o ); \
  static inline bl_t lion_nop_ar2_logic_unequal_s_reserved( const lion_nop_ar2_logic_unequal_s* o ); \
  static inline sz_t lion_nop_ar2_logic_unequal_s_priority( const lion_nop_ar2_logic_unequal_s* o ); \
  static inline bl_t lion_nop_ar2_logic_unequal_s_eci( const lion_nop_ar2_logic_unequal_s* o ); \
  static inline sc_t lion_nop_ar2_logic_unequal_s_symbol( const lion_nop_ar2_logic_unequal_s* o ); \
  static inline tp_t lion_nop_ar2_logic_unequal_s_type_vop_ap( const lion_nop_ar2_logic_unequal_s* o ); \
  static inline sz_t lion_nop_ar2_logic_unequal_s_mcode_push_dp_holor( const lion_nop_ar2_logic_unequal_s* o, const lion_nop_solve_result_s* result, const bhvm_vop_arr_ci_s* arr_ci, bhvm_mcode_frame_s* mcf ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_logic_larger_s \
  ...
  static inline sz_t lion_nop_ar2_logic_larger_s_arity( const lion_nop_ar2_logic_larger_s* o ); \
  static inline bl_t lion_nop_ar2_logic_larger_s_reserved( const lion_nop_ar2_logic_larger_s* o ); \
  static inline sz_t lion_nop_ar2_logic_larger_s_priority( const lion_nop_ar2_logic_larger_s* o ); \
  static inline bl_t lion_nop_ar2_logic_larger_s_eci( const lion_nop_ar2_logic_larger_s* o ); \
  static inline sc_t lion_nop_ar2_logic_larger_s_symbol( const lion_nop_ar2_logic_larger_s* o ); \
  static inline tp_t lion_nop_ar2_logic_larger_s_type_vop_ap( const lion_nop_ar2_logic_larger_s* o ); \
  static inline sz_t lion_nop_ar2_logic_larger_s_mcode_push_dp_holor( const lion_nop_ar2_logic_larger_s* o, const lion_nop_solve_result_s* result, const bhvm_vop_arr_ci_s* arr_ci, bhvm_mcode_frame_s* mcf ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_logic_smaller_s \
  ...
  static inline sz_t lion_nop_ar2_logic_smaller_s_arity( const lion_nop_ar2_logic_smaller_s* o ); \
  static inline bl_t lion_nop_ar2_logic_smaller_s_reserved( const lion_nop_ar2_logic_smaller_s* o ); \
  static inline sz_t lion_nop_ar2_logic_smaller_s_priority( const lion_nop_ar2_logic_smaller_s* o ); \
  static inline bl_t lion_nop_ar2_logic_smaller_s_eci( const lion_nop_ar2_logic_smaller_s* o ); \
  static inline sc_t lion_nop_ar2_logic_smaller_s_symbol( const lion_nop_ar2_logic_smaller_s* o ); \
  static inline tp_t lion_nop_ar2_logic_smaller_s_type_vop_ap( const lion_nop_ar2_logic_smaller_s* o ); \
  static inline sz_t lion_nop_ar2_logic_smaller_s_mcode_push_dp_holor( const lion_nop_ar2_logic_smaller_s* o, const lion_nop_solve_result_s* result, const bhvm_vop_arr_ci_s* arr_ci, bhvm_mcode_frame_s* mcf ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_logic_larger_equal_s \
  ...
  static inline sz_t lion_nop_ar2_logic_larger_equal_s_arity( const lion_nop_ar2_logic_larger_equal_s* o ); \
  static inline bl_t lion_nop_ar2_logic_larger_equal_s_reserved( const lion_nop_ar2_logic_larger_equal_s* o ); \
  static inline sz_t lion_nop_ar2_logic_larger_equal_s_priority( const lion_nop_ar2_logic_larger_equal_s* o ); \
  static inline bl_t lion_nop_ar2_logic_larger_equal_s_eci( const lion_nop_ar2_logic_larger_equal_s* o ); \
  static inline sc_t lion_nop_ar2_logic_larger_equal_s_symbol( const lion_nop_ar2_logic_larger_equal_s* o ); \
  static inline tp_t lion_nop_ar2_logic_larger_equal_s_type_vop_ap( const lion_nop_ar2_logic_larger_equal_s* o ); \
  static inline sz_t lion_nop_ar2_logic_larger_equal_s_mcode_push_dp_holor( const lion_nop_ar2_logic_larger_equal_s* o, const lion_nop_solve_result_s* result, const bhvm_vop_arr_ci_s* arr_ci, bhvm_mcode_frame_s* mcf ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_logic_smaller_equal_s \
  ...
  static inline sz_t lion_nop_ar2_logic_smaller_equal_s_arity( const lion_nop_ar2_logic_smaller_equal_s* o ); \
  static inline bl_t lion_nop_ar2_logic_smaller_equal_s_reserved( const lion_nop_ar2_logic_smaller_equal_s* o ); \
  static inline sz_t lion_nop_ar2_logic_smaller_equal_s_priority( const lion_nop_ar2_logic_smaller_equal_s* o ); \
  static inline bl_t lion_nop_ar2_logic_smaller_equal_s_eci( const lion_nop_ar2_logic_smaller_equal_s* o ); \
  static inline sc_t lion_nop_ar2_logic_smaller_equal_s_symbol( const lion_nop_ar2_logic_smaller_equal_s* o ); \
  static inline tp_t lion_nop_ar2_logic_smaller_equal_s_type_vop_ap( const lion_nop_ar2_logic_smaller_equal_s* o ); \
  static inline sz_t lion_nop_ar2_logic_smaller_equal_s_mcode_push_dp_holor( const lion_nop_ar2_logic_smaller_equal_s* o, const lion_nop_solve_result_s* result, const bhvm_vop_arr_ci_s* arr_ci, bhvm_mcode_frame_s* mcf ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_logic_and_s \
  ...
  static inline sz_t lion_nop_ar2_logic_and_s_arity( const lion_nop_ar2_logic_and_s* o ); \
  static inline bl_t lion_nop_ar2_logic_and_s_reserved( const lion_nop_ar2_logic_and_s* o ); \
  static inline sz_t lion_nop_ar2_logic_and_s_priority( const lion_nop_ar2_logic_and_s* o ); \
  static inline bl_t lion_nop_ar2_logic_and_s_eci( const lion_nop_ar2_logic_and_s* o ); \
  static inline sc_t lion_nop_ar2_logic_and_s_symbol( const lion_nop_ar2_logic_and_s* o ); \
  static inline tp_t lion_nop_ar2_logic_and_s_type_vop_ap( const lion_nop_ar2_logic_and_s* o ); \
  static inline sz_t lion_nop_ar2_logic_and_s_mcode_push_dp_holor( const lion_nop_ar2_logic_and_s* o, const lion_nop_solve_result_s* result, const bhvm_vop_arr_ci_s* arr_ci, bhvm_mcode_frame_s* mcf ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_logic_or_s \
  ...
  static inline sz_t lion_nop_ar2_logic_or_s_arity( const lion_nop_ar2_logic_or_s* o ); \
  static inline bl_t lion_nop_ar2_logic_or_s_reserved( const lion_nop_ar2_logic_or_s* o ); \
  static inline sz_t lion_nop_ar2_logic_or_s_priority( const lion_nop_ar2_logic_or_s* o ); \
  static inline bl_t lion_nop_ar2_logic_or_s_eci( const lion_nop_ar2_logic_or_s* o ); \
  static inline sc_t lion_nop_ar2_logic_or_s_symbol( const lion_nop_ar2_logic_or_s* o ); \
  static inline tp_t lion_nop_ar2_logic_or_s_type_vop_ap( const lion_nop_ar2_logic_or_s* o ); \
  static inline sz_t lion_nop_ar2_logic_or_s_mcode_push_dp_holor( const lion_nop_ar2_logic_or_s* o, const lion_nop_solve_result_s* result, const bhvm_vop_arr_ci_s* arr_ci, bhvm_mcode_frame_s* mcf ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_cat_s \
  ...
  static inline sz_t lion_nop_ar2_cat_s_arity( const lion_nop_ar2_cat_s* o ); \
  static inline bl_t lion_nop_ar2_cat_s_reserved( const lion_nop_ar2_cat_s* o ); \
  static inline sz_t lion_nop_ar2_cat_s_priority( const lion_nop_ar2_cat_s* o ); \
  static inline sc_t lion_nop_ar2_cat_s_symbol( const lion_nop_ar2_cat_s* o ); \
  bl_t lion_nop_ar2_cat_s_solve( const lion_nop_ar2_cat_s* o, lion_holor_s** a, lion_nop_solve_result_s* result ); \
  static inline tp_t lion_nop_ar2_cat_s_type_vop_ap( const lion_nop_ar2_cat_s* o ); \
  static inline tp_t lion_nop_ar2_cat_s_type_vop_dp_a( const lion_nop_ar2_cat_s* o ); \
  static inline tp_t lion_nop_ar2_cat_s_type_vop_dp_b( const lion_nop_ar2_cat_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_ccat_s \
  ...
  static inline sz_t lion_nop_ar2_ccat_s_arity( const lion_nop_ar2_ccat_s* o ); \
  static inline bl_t lion_nop_ar2_ccat_s_reserved( const lion_nop_ar2_ccat_s* o ); \
  static inline sz_t lion_nop_ar2_ccat_s_priority( const lion_nop_ar2_ccat_s* o ); \
  static inline sc_t lion_nop_ar2_ccat_s_symbol( const lion_nop_ar2_ccat_s* o ); \
  bl_t lion_nop_ar2_ccat_s_solve( const lion_nop_ar2_ccat_s* o, lion_holor_s** a, lion_nop_solve_result_s* result ); \
  static inline tp_t lion_nop_ar2_ccat_s_type_vop_ap( const lion_nop_ar2_ccat_s* o ); \
  static inline tp_t lion_nop_ar2_ccat_s_type_vop_dp_a( const lion_nop_ar2_ccat_s* o ); \
  static inline tp_t lion_nop_ar2_ccat_s_type_vop_dp_b( const lion_nop_ar2_ccat_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_order_inc_s \
  ...
  static inline sz_t lion_nop_ar2_order_inc_s_arity( const lion_nop_ar2_order_inc_s* o ); \
  static inline bl_t lion_nop_ar2_order_inc_s_reserved( const lion_nop_ar2_order_inc_s* o ); \
  static inline sz_t lion_nop_ar2_order_inc_s_priority( const lion_nop_ar2_order_inc_s* o ); \
  static inline sc_t lion_nop_ar2_order_inc_s_symbol( const lion_nop_ar2_order_inc_s* o ); \
  ...
  static inline tp_t lion_nop_ar2_order_inc_s_type_vop_dp_a( const lion_nop_ar2_order_inc_s* o ); \
  static inline tp_t lion_nop_ar2_order_inc_s_type_vop_dp_b( const lion_nop_ar2_order_inc_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_order_dec_s \
  ...
  static inline sz_t lion_nop_ar2_order_dec_s_arity( const lion_nop_ar2_order_dec_s* o ); \
  static inline bl_t lion_nop_ar2_order_dec_s_reserved( const lion_nop_ar2_order_dec_s* o ); \
  static inline sz_t lion_nop_ar2_order_dec_s_priority( const lion_nop_ar2_order_dec_s* o ); \
  static inline sc_t lion_nop_ar2_order_dec_s_symbol( const lion_nop_ar2_order_dec_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_cyclic_s \
  ...
  static inline sz_t lion_nop_ar2_cyclic_s_arity( const lion_nop_ar2_cyclic_s* o ); \
  static inline bl_t lion_nop_ar2_cyclic_s_reserved( const lion_nop_ar2_cyclic_s* o ); \
  static inline sz_t lion_nop_ar2_cyclic_s_priority( const lion_nop_ar2_cyclic_s* o ); \
  static inline bl_t lion_nop_ar2_cyclic_s_is_cyclic( const lion_nop_ar2_cyclic_s* o ); \
  ...
  static inline void lion_nop_ar2_cyclic_s_mcode_push_ap_track( const lion_nop_ar2_cyclic_s* o, const lion_nop_solve_result_s* result, const bhvm_vop_arr_ci_s* arr_ci, bhvm_mcode_frame_s* mcf ); \
  static inline void lion_nop_ar2_cyclic_s_mcode_push_dp_track( const lion_nop_ar2_cyclic_s* o, const lion_nop_solve_result_s* result, u0_t ch_id, const bhvm_vop_arr_ci_s* arr_ci, bhvm_mcode_frame_s* mcf ); \
  static inline sz_t lion_nop_ar2_cyclic_s_mcode_push_dp_holor( const lion_nop_ar2_cyclic_s* o, const lion_nop_solve_result_s* result, const bhvm_vop_arr_ci_s* arr_ci, bhvm_mcode_frame_s* mcf ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_rands_s \
  ...
  static inline sz_t lion_nop_ar2_rands_s_arity( const lion_nop_ar2_rands_s* o ); \
  static inline bl_t lion_nop_ar2_rands_s_reserved( const lion_nop_ar2_rands_s* o ); \
  static inline sc_t lion_nop_ar2_rands_s_symbol( const lion_nop_ar2_rands_s* o ); \
  static inline sz_t lion_nop_ar2_rands_s_priority( const lion_nop_ar2_rands_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_nop_ar2_reshape_s \
  ...
  static inline sz_t lion_nop_ar2_reshape_s_arity( const lion_nop_ar2_reshape_s* o ); \
  static inline bl_t lion_nop_ar2_reshape_s_reserved( const lion_nop_ar2_reshape_s* o ); \
  static inline sc_t lion_nop_ar2_reshape_s_symbol( const lion_nop_ar2_reshape_s* o ); \
  static inline sz_t lion_nop_ar2_reshape_s_priority( const lion_nop_ar2_reshape_s* o ); \
...
#define BETH_EXPAND_GROUP_lion_nop_ar2 \
  ...
  XOILA_DECLARE_SPECT( lion_nop_ar2 ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( lion_nop_ar2 ) \
...
#define TYPEOF_lion_nop_ar3_spect_s 0x07993E3991C74EFEull
...
#define BETH_EXPAND_ITEM_lion_nop_ar3_iff_s \
  ...
  static inline sz_t lion_nop_ar3_iff_s_arity( const lion_nop_ar3_iff_s* o ); \
  static inline bl_t lion_nop_ar3_iff_s_reserved( const lion_nop_ar3_iff_s* o ); \
  static inline sz_t lion_nop_ar3_iff_s_priority( const lion_nop_ar3_iff_s* o ); \
  static inline bl_t lion_nop_ar3_iff_s_eci( const lion_nop_ar3_iff_s* o ); \
  static inline sc_t lion_nop_ar3_iff_s_symbol( const lion_nop_ar3_iff_s* o ); \
  static inline tp_t lion_nop_ar3_iff_s_type_vop_ap( const lion_nop_ar3_iff_s* o ); \
  static inline tp_t lion_nop_ar3_iff_s_type_vop_dp_a( const lion_nop_ar3_iff_s* o ); \
  static inline tp_t lion_nop_ar3_iff_s_type_vop_dp_b( const lion_nop_ar3_iff_s* o ); \
  static inline tp_t lion_nop_ar3_iff_s_type_vop_dp_c( const lion_nop_ar3_iff_s* o ); \
...
#define BETH_EXPAND_GROUP_lion_nop_ar3 \
  ...
  XOILA_DECLARE_SPECT( lion_nop_ar3 ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( lion_nop_ar3 ) \
...
#define TYPEOF_lion_eval_nop_spect_s 0xD53CA5ABB63F68E8ull
...
#define BETH_EXPAND_ITEM_lion_eval_nop_param_s \
  ...
  static inline void lion_eval_nop_param_s_init_x( lion_eval_nop_param_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_eval_nop_generator_s \
  ...
  static inline void lion_eval_nop_generator_s_set_param( lion_eval_nop_generator_s* o, const lion_eval_nop_param_s* param ); \
...
#define BETH_EXPAND_ITEM_lion_eval_nop_show_param_s \
  ...
  static inline void lion_eval_nop_show_param_s_set_param( lion_eval_nop_show_param_s* o, const lion_eval_nop_param_s* param ); \
  er_t lion_eval_nop_show_param_s_main( lion_eval_nop_show_param_s* o, bcore_main_frame_s* frame ); \
  static inline lion_eval_nop_result_s* lion_eval_nop_show_param_s_run( const lion_eval_nop_show_param_s* o, lion_eval_nop_result_s* result ); \
...
#define BETH_EXPAND_ITEM_lion_eval_nop_arr_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_LINK_STATIC_S( lion_eval_nop, ); \
  }; \
...
#define BETH_EXPAND_ITEM_lion_eval_nop_set_s \
  ...
  static inline void lion_eval_nop_set_s_set_param( lion_eval_nop_set_s* o, const lion_eval_nop_param_s* param ); \
...
#define BETH_EXPAND_ITEM_lion_eval_nop_ar1_s \
  ...
  static inline void lion_eval_nop_ar1_s_set_param( lion_eval_nop_ar1_s* o, const lion_eval_nop_param_s* param ); \
...
#define BETH_EXPAND_ITEM_lion_eval_nop_ar2_s \
  ...
  static inline void lion_eval_nop_ar2_s_set_param( lion_eval_nop_ar2_s* o, const lion_eval_nop_param_s* param ); \
...
#define BETH_EXPAND_GROUP_lion_eval_nop \
  ...
  XOILA_DECLARE_SPECT( lion_eval_nop ) \
  { \
      bcore_spect_header_s header; \
  ...
  static inline void lion_eval_nop_a_set_param( lion_eval_nop* o, const lion_eval_nop_param_s* param ){ const lion_eval_nop_spect_s* p = lion_eval_nop_spect_s_get_aware( o ); assert( p->set_param ); p->set_param( o, param );} \
  static inline bl_t lion_eval_nop_a_defines_set_param( const lion_eval_nop* o ){ return  lion_eval_nop_spect_s_get_aware( o )->set_param != NULL;} \
  static inline lion_eval_nop_result_s* lion_eval_nop_a_run( const lion_eval_nop* o, lion_eval_nop_result_s* result ){ const lion_eval_nop_spect_s* p = lion_eval_nop_spect_s_get_aware( o ); assert( p->run ); return p->run( o, result );} \
  static inline bl_t lion_eval_nop_a_defines_run( const lion_eval_nop* o ){ return  lion_eval_nop_spect_s_get_aware( o )->run != NULL;} \
...
#define TYPEOF_lion_sem_spect_s 0x78DE93369617C58Bull
...
#define BETH_EXPAND_ITEM_lion_sem_link_s \
  ...
  static inline tp_t lion_sem_link_s_get_name( const lion_sem_link_s* o ); \
  static inline bl_t lion_sem_link_s_is_visible( const lion_sem_link_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_sem_links_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_LINK_STATIC_S( lion_sem_link_s, ); \
  }; \
...
#define BETH_EXPAND_ITEM_lion_sem_body_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_LINK_STATIC_S( lion_sem, ); \
  }; \
...
#define BETH_EXPAND_ITEM_lion_sem_cell_s \
  ...
  { \
      ...
      lion_nop* nop; \
      lion_sem_cell_s* wrapped_cell; \
      sz_t priority; \
      lion_sem_cell_s* parent; \
      bcore_source_point_s source_point; \
  }; \
  static inline tp_t lion_sem_cell_s_get_name( const lion_sem_cell_s* o ); \
  static inline sz_t lion_sem_cell_s_get_arity( const lion_sem_cell_s* o ); \
  static inline lion_sem_link_s* lion_sem_cell_s_get_enc_by_name( lion_sem_cell_s* o, tp_t name ); \
  static inline lion_sem_link_s* lion_sem_cell_s_get_exc_by_name( lion_sem_cell_s* o, tp_t name ); \
  static inline lion_sem_link_s* lion_sem_cell_s_get_enc_by_open( lion_sem_cell_s* o ); \
  static inline lion_sem_link_s* lion_sem_cell_s_get_enc_by_dn( lion_sem_cell_s* o, lion_sem_link_s* dn ); \
  static inline sz_t lion_sem_cell_s_get_priority( const lion_sem_cell_s* o ); \
  static inline bl_t lion_sem_cell_s_is_wrapper( const lion_sem_cell_s* o ); \
...
#define BETH_EXPAND_GROUP_lion_sem \
  ...
  static inline tp_t lion_sem_a_get_name( const lion_sem* o ){ const lion_sem_spect_s* p = lion_sem_spect_s_get_aware( o ); assert( p->get_name ); return p->get_name( o );} \
  static inline bl_t lion_sem_a_defines_get_name( const lion_sem* o ){ return  true;} \
  static inline tp_t lion_sem_get_name_default( const lion_sem* o ){ return  0;} \
  static inline bl_t lion_sem_a_is_visible( const lion_sem* o ){ const lion_sem_spect_s* p = lion_sem_spect_s_get_aware( o ); assert( p->is_visible ); return p->is_visible( o );} \
  static inline bl_t lion_sem_a_defines_is_visible( const lion_sem* o ){ return  true;} \
  static inline bl_t lion_sem_is_visible_default( const lion_sem* o ){ return  true;} \
...
#define TYPEOF_lion_ctr_spect_s 0xB965DE05F7D1E06Full
...
#define BETH_EXPAND_ITEM_lion_ctr_node_s \
  ...
  { \
      ...
      sz_t id; \
      lion_sem_cell_s* cell; \
      lion_ctr_node_s* parent; \
      BCORE_ARRAY_DYN_LINK_STATIC_S( lion_ctr_node_s, ); \
  }; \
...
#define BETH_EXPAND_GROUP_lion_ctr \
  ...
  XOILA_DECLARE_SPECT( lion_ctr ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( lion_ctr ) \
...
#define TYPEOF_lion_net_spect_s 0x5127954173C2B80Bull
...
#define BETH_EXPAND_ITEM_lion_net_links_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_LINK_STATIC_S( lion_net_link_s, ); \
  }; \
...
#define BETH_EXPAND_ITEM_lion_net_node_s \
  ...
  static inline bl_t lion_net_node_s_is_cyclic( const lion_net_node_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_net_node_adl_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_LINK_STATIC_S( lion_net_node_s, ); \
  }; \
...
#define BETH_EXPAND_ITEM_lion_net_cell_s \
  ...
  static inline void lion_net_cell_s_mutated( lion_net_cell_s* o ); \
...
#define BETH_EXPAND_GROUP_lion_net \
  ...
  static inline bl_t lion_net_a_is_cyclic( const lion_net* o ){ const lion_net_spect_s* p = lion_net_spect_s_get_aware( o ); assert( p->is_cyclic ); return p->is_cyclic( o );} \
  static inline bl_t lion_net_a_defines_is_cyclic( const lion_net* o ){ return  true;} \
  static inline bl_t lion_net_is_cyclic_default( const lion_net* o ){ return  false;} \
...
#define TYPEOF_lion_frame_spect_s 0x2485D4B341958909ull
...
#define BETH_EXPAND_ITEM_lion_frame_s \
  ...
  static inline void lion_frame_s_shelve( lion_frame_s* o ); \
  static inline void lion_frame_s_mutated( lion_frame_s* o ); \
  static inline void lion_frame_s_copy_x( lion_frame_s* o, const lion_frame_s* src ); \
  lion_frame_s* lion_frame_s_setup_from_source( lion_frame_s* o, bcore_source* source, const bhvm_holor_s** en, sz_t size_en ); \
  static inline lion_frame_s* lion_frame_s_setup_from_st( lion_frame_s* o, const st_s* st, const bhvm_holor_s** en, sz_t size_en ); \
  static inline lion_frame_s* lion_frame_s_setup_from_sc( lion_frame_s* o, sc_t sc, const bhvm_holor_s** en, sz_t size_en ); \
  static inline lion_frame_s* lion_frame_s_create_from_source( bcore_source* source, const bhvm_holor_s** en, sz_t size_en ); \
  static inline lion_frame_s* lion_frame_s_create_from_st( const st_s* st, const bhvm_holor_s** en, sz_t size_en ); \
  static inline lion_frame_s* lion_frame_s_create_from_sc( sc_t sc, const bhvm_holor_s** en, sz_t size_en ); \
  static inline lion_frame_s* lion_frame_s_setup_from_source_adl( lion_frame_s* o, bcore_source* source, const bhvm_holor_adl_s* en ); \
  static inline lion_frame_s* lion_frame_s_setup_from_st_adl( lion_frame_s* o, const st_s* st, const bhvm_holor_adl_s* en ); \
  static inline lion_frame_s* lion_frame_s_setup_from_sc_adl( lion_frame_s* o, sc_t sc, const bhvm_holor_adl_s* en ); \
  static inline lion_frame_s* lion_frame_s_create_from_source_adl( bcore_source* source, const bhvm_holor_adl_s* en ); \
  static inline lion_frame_s* lion_frame_s_create_from_st_adl( const st_s* st, const bhvm_holor_adl_s* en ); \
  static inline lion_frame_s* lion_frame_s_create_from_sc_adl( sc_t sc, const bhvm_holor_adl_s* en ); \
  static inline sz_t lion_frame_s_get_size_en( const lion_frame_s* o ); \
  static inline sz_t lion_frame_s_get_size_ex( const lion_frame_s* o ); \
  static inline sz_t lion_frame_s_get_size_ada( const lion_frame_s* o ); \
  static inline bhvm_holor_s* lion_frame_s_get_ap_en( lion_frame_s* o, sz_t index ); \
  static inline bhvm_holor_s* lion_frame_s_get_dp_en( lion_frame_s* o, sz_t index ); \
  static inline bhvm_holor_s* lion_frame_s_get_ap_ex( lion_frame_s* o, sz_t index ); \
  static inline bhvm_holor_s* lion_frame_s_get_dp_ex( lion_frame_s* o, sz_t index ); \
  static inline bhvm_holor_s* lion_frame_s_get_ap_ada( lion_frame_s* o, sz_t index ); \
  static inline bhvm_holor_s* lion_frame_s_get_dp_ada( lion_frame_s* o, sz_t index ); \
  ...
  static inline void lion_frame_s_copy_x( lion_frame_s* o, const lion_frame_s* src ){ if( o->setup ) { lion_frame_s_reset( o ); lion_frame_s_setup( o ); }  lion_frame_s_check_integrity( o );} \
...
#define BETH_EXPAND_ITEM_lion_frame_cyclic_s \
  ...
  static inline void lion_frame_cyclic_s_shelve( lion_frame_cyclic_s* o ); \
  static inline void lion_frame_cyclic_s_mutated( lion_frame_cyclic_s* o ); \
  static inline void lion_frame_cyclic_s_copy_x( lion_frame_cyclic_s* o, const lion_frame_cyclic_s* src ); \
  static inline sz_t lion_frame_cyclic_s_get_size_en( const lion_frame_cyclic_s* o ); \
  static inline sz_t lion_frame_cyclic_s_get_size_ex( const lion_frame_cyclic_s* o ); \
  static inline sz_t lion_frame_cyclic_s_get_size_ada( const lion_frame_cyclic_s* o ); \
  ...
  static inline void lion_frame_cyclic_s_copy_x( lion_frame_cyclic_s* o, const lion_frame_cyclic_s* src ){ if( o->setup ) { lion_frame_cyclic_s_reset( o ); lion_frame_cyclic_s_setup( o ); }} \
...
#define BETH_EXPAND_GROUP_lion_frame \
  ...
  XOILA_DECLARE_SPECT( lion_frame ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( lion_frame ) \
...
#define TYPEOF_lion_frame_hidx_spect_s 0xADC020AFDC25F299ull
...
#define BETH_EXPAND_ITEM_lion_frame_hidx_s \
  ...
  static inline lion_frame_hidx_s* lion_frame_hidx_s_clear( lion_frame_hidx_s* o ); \
  static inline lion_frame_hidx_s* lion_frame_hidx_s_push( lion_frame_hidx_s* o, sz_t index ); \
  static inline sz_t lion_frame_hidx_s_get_idx( const lion_frame_hidx_s* o, sz_t index ); \
  static inline sz_t lion_frame_hidx_s_get_size( const lion_frame_hidx_s* o ); \
  static inline bhvm_holor_s* lion_frame_hidx_s_get_holor( const lion_frame_hidx_s* o, const bhvm_mcode_hbase_s* hbase, sz_t index ); \
  static inline bhvm_mcode_hmeta* lion_frame_hidx_s_get_hmeta( const lion_frame_hidx_s* o, const bhvm_mcode_hbase_s* hbase, sz_t index ); \
  sz_t lion_frame_hidx_s_get_pclass_idx( const lion_frame_hidx_s* o, const bhvm_mcode_hbase_s* hbase, tp_t pclass, sz_t index ); \
  static inline bhvm_holor_s* lion_frame_hidx_s_get_pclass_holor( const lion_frame_hidx_s* o, const bhvm_mcode_hbase_s* hbase, tp_t pclass, sz_t index ); \
  static inline bhvm_mcode_hmeta* lion_frame_hidx_s_get_pclass_hmeta( const lion_frame_hidx_s* o, const bhvm_mcode_hbase_s* hbase, tp_t pclass, sz_t index ); \
...
#define BETH_EXPAND_ITEM_lion_frame_hidx_ads_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_SOLID_STATIC_S( lion_frame_hidx_s, ); \
  }; \
...
#define BETH_EXPAND_GROUP_lion_frame_hidx \
  ...
  XOILA_DECLARE_SPECT( lion_frame_hidx ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( lion_frame_hidx ) \
...
#define TYPEOF_lion_eval_frame_spect_s 0xF84A629E1B7E06D8ull
...
#define BETH_EXPAND_ITEM_lion_eval_frame_param_s \
  ...
  static inline void lion_eval_frame_param_s_init_x( lion_eval_frame_param_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_eval_frame_show_param_s \
  ...
  static inline void lion_eval_frame_show_param_s_set_param( lion_eval_frame_show_param_s* o, const lion_eval_frame_param_s* param ); \
  er_t lion_eval_frame_show_param_s_main( lion_eval_frame_show_param_s* o, bcore_main_frame_s* frame ); \
  static inline lion_eval_frame_result_s* lion_eval_frame_show_param_s_run( const lion_eval_frame_show_param_s* o, lion_eval_frame_result_s* result ); \
...
#define BETH_EXPAND_ITEM_lion_eval_frame_arr_s \
  ...
  { \
      aware_t _; \
      BCORE_ARRAY_DYN_LINK_STATIC_S( lion_eval_frame, ); \
  }; \
...
#define BETH_EXPAND_ITEM_lion_eval_frame_set_s \
  ...
  static inline void lion_eval_frame_set_s_set_param( lion_eval_frame_set_s* o, const lion_eval_frame_param_s* param ); \
...
#define BETH_EXPAND_ITEM_lion_eval_frame_plain_s \
  ...
  static inline void lion_eval_frame_plain_s_set_param( lion_eval_frame_plain_s* o, const lion_eval_frame_param_s* param ); \
...
#define BETH_EXPAND_ITEM_lion_eval_frame_cyclic_s \
  ...
  static inline void lion_eval_frame_cyclic_s_set_param( lion_eval_frame_cyclic_s* o, const lion_eval_frame_param_s* param ); \
...
#define BETH_EXPAND_GROUP_lion_eval_frame \
  ...
  XOILA_DECLARE_SPECT( lion_eval_frame ) \
  { \
      bcore_spect_header_s header; \
  ...
  static inline lion_eval_frame_result_s* lion_eval_frame_a_run( const lion_eval_frame* o, lion_eval_frame_result_s* result ){ const lion_eval_frame_spect_s* p = lion_eval_frame_spect_s_get_aware( o ); assert( p->run ); return p->run( o, result );} \
  static inline bl_t lion_eval_frame_a_defines_run( const lion_eval_frame* o ){ return  lion_eval_frame_spect_s_get_aware( o )->run != NULL;} \
  BETH_EXPAND_ITEM_lion_eval_frame_param_s \
  BETH_EXPAND_ITEM_lion_eval_frame_show_param_s \
  static inline void lion_eval_frame_a_set_param( lion_eval_frame* o, const lion_eval_frame_param_s* param ){ const lion_eval_frame_spect_s* p = lion_eval_frame_spect_s_get_aware( o ); assert( p->set_param ); p->set_param( o, param );} \
  static inline bl_t lion_eval_frame_a_defines_set_param( const lion_eval_frame* o ){ return  lion_eval_frame_spect_s_get_aware( o )->set_param != NULL;} \
...
#define TYPEOF_lion_adaptive_spect_s 0x9FFA9D357108D5E2ull
...
#define BETH_EXPAND_ITEM_lion_adaptive_s \
  ...
  static inline sz_t lion_adaptive_s_get_in_size( const lion_adaptive_s* o ); \
  static inline sz_t lion_adaptive_s_get_out_size( const lion_adaptive_s* o ); \
  static inline void lion_adaptive_s_get_dynamics_std( const lion_adaptive_s* o, badapt_dynamics_std_s* dynamics ); \
  static inline void lion_adaptive_s_set_dynamics_std( lion_adaptive_s* o, const badapt_dynamics_std_s* dynamics ); \
...
#define BETH_EXPAND_ITEM_lion_adaptive_builder_s \
  ...
  static inline sz_t lion_adaptive_builder_s_get_in_size( const lion_adaptive_builder_s* o ); \
  static inline void lion_adaptive_builder_s_set_in_size( lion_adaptive_builder_s* o, sz_t size ); \
  static inline sz_t lion_adaptive_builder_s_get_out_size( const lion_adaptive_builder_s* o ); \
  static inline void lion_adaptive_builder_s_set_out_size( lion_adaptive_builder_s* o, sz_t size ); \
...
#define BETH_EXPAND_ITEM_lion_adaptive_cyclic_s \
  ...
  static inline sz_t lion_adaptive_cyclic_s_get_in_size( const lion_adaptive_cyclic_s* o ); \
  static inline sz_t lion_adaptive_cyclic_s_get_out_size( const lion_adaptive_cyclic_s* o ); \
  static inline void lion_adaptive_cyclic_s_get_dynamics_std( const lion_adaptive_cyclic_s* o, badapt_dynamics_std_s* dynamics ); \
  static inline void lion_adaptive_cyclic_s_set_dynamics_std( lion_adaptive_cyclic_s* o, const badapt_dynamics_std_s* dynamics ); \
...
#define BETH_EXPAND_ITEM_lion_adaptive_cyclic_builder_s \
  ...
  static inline sz_t lion_adaptive_cyclic_builder_s_get_in_size( const lion_adaptive_cyclic_builder_s* o ); \
  static inline void lion_adaptive_cyclic_builder_s_set_in_size( lion_adaptive_cyclic_builder_s* o, sz_t size ); \
  static inline sz_t lion_adaptive_cyclic_builder_s_get_out_size( const lion_adaptive_cyclic_builder_s* o ); \
  static inline void lion_adaptive_cyclic_builder_s_set_out_size( lion_adaptive_cyclic_builder_s* o, sz_t size ); \
...
#define BETH_EXPAND_GROUP_lion_adaptive \
  ...
  XOILA_DECLARE_SPECT( lion_adaptive ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( lion_adaptive ) \
...
#define TYPEOF_lion_adaptor_spect_s 0x901BF78926207449ull
...
#define BETH_EXPAND_ITEM_lion_adaptor_frame_s \
  ...
  static inline void lion_adaptor_frame_s_reset( lion_adaptor_frame_s* o ); \
...
#define BETH_EXPAND_GROUP_lion_adaptor \
  ...
  XOILA_DECLARE_SPECT( lion_adaptor ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( lion_adaptor ) \
...
#define TYPEOF_lion_adaptive_bhpt_spect_s 0x93EBF359B105E329ull
...
#define BETH_EXPAND_ITEM_lion_adaptive_bhpt_s \
  ...
  static inline bhvm_holor_s* lion_adaptive_bhpt_s_get_format_en( const lion_adaptive_bhpt_s* o, bhvm_holor_s* format ); \
  static inline bhvm_holor_s* lion_adaptive_bhpt_s_get_format_ex( const lion_adaptive_bhpt_s* o, bhvm_holor_s* format ); \
  ...
  static inline void lion_adaptive_bhpt_s_rebind_holors( lion_adaptive_bhpt_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_adaptive_bhpt_builder_s \
  ...
  static inline void lion_adaptive_bhpt_builder_s_set_format_en( lion_adaptive_bhpt_builder_s* o, const bhvm_holor_s* format ); \
  static inline void lion_adaptive_bhpt_builder_s_set_format_ex( lion_adaptive_bhpt_builder_s* o, const bhvm_holor_s* format ); \
...
#define BETH_EXPAND_ITEM_lion_adaptive_bhpt_cyclic_s \
  ...
  static inline bhvm_holor_s* lion_adaptive_bhpt_cyclic_s_get_format_en( const lion_adaptive_bhpt_cyclic_s* o, bhvm_holor_s* format ); \
  static inline bhvm_holor_s* lion_adaptive_bhpt_cyclic_s_get_format_ex( const lion_adaptive_bhpt_cyclic_s* o, bhvm_holor_s* format ); \
  ...
  static inline void lion_adaptive_bhpt_cyclic_s_rebind_holors( lion_adaptive_bhpt_cyclic_s* o ); \
...
#define BETH_EXPAND_ITEM_lion_adaptive_bhpt_cyclic_builder_s \
  ...
  static inline void lion_adaptive_bhpt_cyclic_builder_s_set_format_en( lion_adaptive_bhpt_cyclic_builder_s* o, const bhvm_holor_s* format ); \
  static inline void lion_adaptive_bhpt_cyclic_builder_s_set_format_ex( lion_adaptive_bhpt_cyclic_builder_s* o, const bhvm_holor_s* format ); \
...
#define BETH_EXPAND_GROUP_lion_adaptive_bhpt \
  ...
  XOILA_DECLARE_SPECT( lion_adaptive_bhpt ) \
  { \
      bcore_spect_header_s header; \
  }; \
  BCORE_DECLARE_VIRTUAL_AWARE_OBJECT( lion_adaptive_bhpt ) \
...
#endif // __lion_xo_H
// XOILA_OUT_SIGNATURE 0x9159B6769B689F81ull
