...
"{"
    ...
    "feature aware lion_nop : reserved = lion_nop_reserved__;"
...
{
    switch( bcore_signal_s_handle_type( o, typeof( "lion_xoila_out" ) ) )
    {
        case TYPEOF_init1:
        {
            ...
            BCORE_REGISTER_FFUNC( lion_nop_reserved, lion_nop_reserved__ );
...
// BETH_PLANT_SIGNATURE 4238949205376804797
