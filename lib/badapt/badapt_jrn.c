...
void badapt_jrn_s_run_training( badapt_supplier* problem, badapt_builder* builder, const badapt_trainer_batch_s* trainer )
{
    BCORE_LIFE_INIT();
...
//    builder->dynamics.lambda_l1 = 0.0001;
    ...
    builder->activator_hidden = badapt_activator_create_from_names( "bias", "tanh" );
