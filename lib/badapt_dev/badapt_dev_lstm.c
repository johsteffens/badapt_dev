...
/**********************************************************************************************************************/
// badapt_dev_lstm_layer_s

void badapt_dev_lstm_layer_s_setup( badapt_dev_lstm_layer_s* o, sz_t size_input, sz_t size_hidden )
{
...
//    bmath_vf3_s_fill( &o->v_d, 1.0 ); // =====================================
}

// ---------------------------------------------------------------------------------------------------------------------

void badapt_dev_lstm_arr_layer_s_setup( badapt_dev_lstm_arr_layer_s* o, sz_t size_arr, sz_t size_input, sz_t size_hidden )
{
    badapt_dev_lstm_arr_layer_s_set_size( o, size_arr );
    for( sz_t i = 0; i < o->arr_size; i++ )
    {
        if( !o->arr_data[ i ] ) o->arr_data[ i ] = badapt_dev_lstm_layer_s_create();
        badapt_dev_lstm_layer_s_setup( o->arr_data[ i ], size_input, size_hidden );
    }
}

// ---------------------------------------------------------------------------------------------------------------------

void badapt_dev_lstm_arr_layer_s_rotate( badapt_dev_lstm_arr_layer_s* o )
{
    if( o->arr_size <= 1 ) return;

    badapt_dev_lstm_layer_s* last_layer = o->arr_data[ o->arr_size - 1 ];
...
void badapt_dev_lstm_s_minfer( badapt_dev_lstm_s* o, const bmath_vf3_s* in, bmath_vf3_s* out )
{
    ...
    badapt_dev_lstm_arr_layer_s_rotate( &o->arr_layer );
    badapt_dev_lstm_layer_s* l = o->arr_layer.arr_data[ 0 ]; // this layer
    badapt_dev_lstm_layer_s* p = o->arr_layer.arr_data[ 1 ]; // previous layer
...
void badapt_dev_lstm_s_bgrad_adapt( badapt_dev_lstm_s* o, bmath_vf3_s* grad_in, const bmath_vf3_s* grad_out )
{
    ...
    const badapt_dev_lstm_layer_s* l = o->arr_layer.arr_data[ 0 ];
    const badapt_dev_lstm_layer_s* p = NULL;
...
void badapt_dev_lstm_s_reset( badapt_dev_lstm_s* o )
{
    ...
    badapt_dev_lstm_arr_layer_s_setup( &o->arr_layer, o->size_unfolded, o->size_input, o->size_hidden );
}

// ---------------------------------------------------------------------------------------------------------------------

void badapt_dev_lstm_s_get_weights_min_max( const badapt_dev_lstm_s* o, f3_t* arg_min, f3_t* arg_max )
{
...
void badapt_dev_lstm_builder_s_set_ern( badapt_dev_lstm_builder_s* o )
{
...
badapt_adaptive* badapt_dev_lstm_builder_s_build( const badapt_dev_lstm_builder_s* o )
{
    ...
    badapt_dev_lstm_s* lstm = badapt_dev_lstm_s_create();
    ...
    bmath_vf3_s_set_size( &lstm->d_b_f, o->size_hidden );
    bmath_vf3_s_set_size( &lstm->d_b_i, o->size_hidden );
    bmath_vf3_s_set_size( &lstm->d_b_o, o->size_hidden );
    bmath_vf3_s_set_size( &lstm->d_b_q, o->size_hidden );

    bmath_mf3_s_set_size( &lstm->d_w_fx, o->size_hidden, o->size_input );
    bmath_mf3_s_set_size( &lstm->d_w_ix, o->size_hidden, o->size_input );
    bmath_mf3_s_set_size( &lstm->d_w_ox, o->size_hidden, o->size_input );
    bmath_mf3_s_set_size( &lstm->d_w_qx, o->size_hidden, o->size_input );
    bmath_mf3_s_set_size( &lstm->d_w_fh, o->size_hidden, o->size_hidden );
    bmath_mf3_s_set_size( &lstm->d_w_ih, o->size_hidden, o->size_hidden );
    bmath_mf3_s_set_size( &lstm->d_w_oh, o->size_hidden, o->size_hidden );
    bmath_mf3_s_set_size( &lstm->d_w_qh, o->size_hidden, o->size_hidden );
    ...
    bmath_vf3_s_set_size( &lstm->v_r,   o->size_output );
    bmath_vf3_s_set_size( &lstm->d_v_r, o->size_output );
    bmath_vf3_s_set_size( &lstm->d_v_f, o->size_hidden );
    bmath_vf3_s_set_size( &lstm->d_v_i, o->size_hidden );
    bmath_vf3_s_set_size( &lstm->d_v_o, o->size_hidden );
    bmath_vf3_s_set_size( &lstm->d_v_q, o->size_hidden );
    bmath_vf3_s_set_size( &lstm->d_v_c, o->size_hidden );
    bmath_vf3_s_set_size( &lstm->d_v_d, o->size_hidden );
    bmath_vf3_s_set_size( &lstm->d_v_h, o->size_hidden );

    badapt_dev_lstm_s_reset( lstm );
...
void badapt_dev_lstm_test_recurrent_abc()
{
    ...
    BCORE_LIFE_CREATE( badapt_dev_lstm_builder_s,      builder );
...
void badapt_dev_lstm_test_recurrent_kjv()
{
    ...
    builder->random_seed        = 111;
    builder->size_unfolded      = 25;
    builder->size_hidden        = 200;
    builder->dynamics.epsilon   = 0.03;
    builder->dynamics.lambda_l2 = 0.00001;
