...
func (opal_frame_cyclic) (void mutable_estimate_jacobian_en( mutable, const bhvm_holor_adl_s* en, f3_t epsilon, bhvm_holor_mdl_s* jac_mdl )) =
{
    ASSERT( o.is_setup );
 ...
 *  jac_mdl stores jacobians in the form [in-channels][out-channels]
 */
func (opal_frame_cyclic) (void estimate_jacobian_en( const, const bhvm_holor_adl_s* en, f3_t epsilon, bhvm_holor_mdl_s* jac_mdl )) =
{
